...
/////////////////////////////////////////////////////////////////////////////
// https: //jsfiddle.net/bkanber/DHU7J/
...
var pleasework = document.getElementById("testButton");
...
pleasework.addEventListener("click", function () {
    ...
    document.getElementById("testBox").value = '';
    document.getElementById("testResultLabel").innerHTML = result.label;
    var mainResult = document.getElementById("testResultProbability");
    mainResult.innerHTML = Math.round(100 * result.score);

   var finalResult = document.getElementById("testResult");
